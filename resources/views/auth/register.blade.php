                ...
                <div class="col-md-8 account-top">
                    <div class="form-horizontal">
                        ...
                        <form method="POST" action="{{ route('post.register') }}"  enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="dateofbirth" class="col-md-4 col-form-label text-md-right">{{ __('Ngày sinh') }}</label>
...
{{--                                    <input id="sex" type="text" class="form-control @error('sex') is-invalid @enderror" name="sex" value="{{ old('sex') }}" required autocomplete="sex">--}}
                                    <select name="sex" id="sex">
                                        <option id="sex1" value="nam">Nam</option>
                                        <option id="sex2" value="nu">Nữ</option>
                                        <option id="sex3" value="khac">Khác</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input id="input_img" type="file" name="avatar" class="form-control" placeholder="ảnh đại diện" onchange="readURL(this)" value="{{old('avatar')}}">
                            </div>
                            <div class="form-group row">
                ...
                @if(isset($sale))
                    @foreach($sale as $sal)
                        ...
                        <div class="col-md-3 left-account ">
                            ...
                            <a href="{{route('get.login')}}" class="create">Đăng nhập</a>
